  ...
  return (
    <header className="h-14 bg-[#080D17]/95 backdrop-blur-md border-b border-[#1B2B40] px-4 md:px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center space-x-3">
        {onToggleMobileSidebar && (
          <button
            ...
            className="md:hidden text-[#94A3B8] hover:text-[#F1F5F9] p-1.5 rounded-lg hover:bg-[#121E30] transition-colors"
        ...
        <div className="flex items-center space-x-2 bg-[#0E1726] border border-[#1B2B40] hover:border-[#1683FF]/40 rounded-lg px-2.5 py-1.5 transition-all shadow-subtle">
          ...
          {cases.length > 0 ? (
            <div className="relative flex items-center">
              <select
                ...
                className="bg-transparent text-xs font-mono text-[#F1F5F9] font-medium pl-1 pr-5 py-0 appearance-none focus:outline-none transition-all cursor-pointer"
              >
                {cases.map(c => (
              ...
              <ChevronDown className="w-3 h-3 text-[#94A3B8] absolute right-0 pointer-events-none" />
            </div>
          ) : (
            <span className="text-[11px] font-mono text-[#64748B]">No Case Bound</span>
          )}
        </div>

        {/* Compact Enterprise Search Input */}
        <div className="hidden lg:flex items-center space-x-2 bg-[#0E1726] border border-[#1B2B40] focus-within:border-[#1683FF]/40 rounded-lg px-2.5 py-1 text-xs transition-all">
          ...
          <input
            ...
            className="bg-transparent border-none outline-none text-xs text-[#F1F5F9] placeholder-[#64748B] w-52 font-sans"
          />
      ...
      <div className="flex items-center space-x-3 text-xs">
        ...
        {isSafeMode ? (
          <div className="hidden sm:flex items-center space-x-1.5 bg-[#20C997]/10 border border-[#20C997]/30 text-[#20C997] px-2.5 py-1 rounded-full font-mono text-[11px] font-medium">
        ...
        {isAuthenticated && user ? (
          <div className="flex items-center space-x-2.5 bg-[#0E1726] border border-[#1B2B40] pl-2 pr-1.5 py-1 rounded-lg shadow-subtle">
